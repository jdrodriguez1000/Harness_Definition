...
1. `design/contract_definitions.md` — lista canónica de IC-xx (fuente de verdad para V1)
2. `specification/bdd_features.md` — lista canónica de SC-xx/SE-xx (fuente de verdad para V2)
3. `plan/vertical_slice_plan.md` — slices formalizadas con IC-xx y BDD scenarios asignados
4. `plan/project_roadmap.md` — secuencia y dependencias entre slices
5. `plan/risk_register.md` — riesgos por slice
...
1. Extraer la lista canónica completa de IC-xx de `design/contract_definitions.md`
2. Extraer todos los IC-xx asignados en `plan/vertical_slice_plan.md` (agregando todos los IC-xx de todas las slices)
...
1. Extraer la lista canónica completa de SC-xx y SE-xx de `specification/bdd_features.md`
2. Extraer todos los SC-xx/SE-xx asignados en `plan/vertical_slice_plan.md` (agregando todos los de todas las slices)
...
1. Extraer la lista de VS-xx en orden de aparición de `plan/project_roadmap.md`
...
1. Extraer la lista completa de VS-xx de `plan/vertical_slice_plan.md`
2. Para cada VS-xx, verificar que aparece en ≥1 RK-xx de `plan/risk_register.md`
...
**LL-01: El Write de `plan/review_report.md` es el PRIMER tool call después de completar el análisis. Sin excepción. No reportar al governor antes de haber escrito este archivo.**

Escribir `plan/review_report.md` con el siguiente formato:
...
CRITICAL_COUNT: <n>
MINOR_COUNT: <n>
report_path: plan/review_report.md
```
